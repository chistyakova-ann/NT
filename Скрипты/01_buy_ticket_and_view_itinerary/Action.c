Action()
{
	lr_start_transaction("01_buy_ticket_and_view_itinerary");
...
Original value='129606.236776023zzzzzcApiAtVzzzHDQQQQpHcticf' 
Name ='userSession' 
Type ='Rule' 
AppName ='WebTours' 
...
/*Correlation comment - Do not change!  Original value='341;566;09/14/2020' Name ='outboundFlight' Type ='ResponseBased'*/
	web_reg_save_param_attrib(
...
/*9	lr_save_string(lr_eval_string("outboundFlight_{random_id}"),"outboundFlight_id");
	...
	*/
	...
	lr_end_transaction("01_buy_ticket_and_view_itinerary",LR_AUTO);
