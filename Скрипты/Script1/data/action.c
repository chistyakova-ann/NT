Action()
{
	...
	lr_start_transaction("UC_1_form_ticket_and_iter");
	...
	web_submit_data("login.pl", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=userSession", "Value=129606.236776023zzzzzcApiAtVzzzHDQQQQpHcticf", ENDITEM, 
	...
	web_submit_data("reservations.pl_2", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=outboundFlight", "Value=341;566;09/14/2020", ENDITEM, 
		"Name=numPassengers", "Value=1", ENDITEM, 
		"Name=advanceDiscount", "Value=0", ENDITEM, 
		"Name=seatType", "Value=Business", ENDITEM, 
		"Name=seatPref", "Value=None", ENDITEM, 
	...
	web_submit_data("reservations.pl_3", 
		...
		"Name=address1", "Value=jgfj", ENDITEM, 
		"Name=address2", "Value=gfjvh", ENDITEM, 
		"Name=pass1", "Value=jojo1 jojo1", ENDITEM, 
		"Name=creditCard", "Value=233656214522", ENDITEM, 
	...
	lr_end_transaction("UC_1_form_ticket_and_iter",LR_AUTO);
